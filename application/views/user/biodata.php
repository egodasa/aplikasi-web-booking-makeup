		...
		<div class="container" data-aos="fade-up">
			...
			<div class="row mt-5">
				...
				<div class="col-md-3">
					<div class="info">
						<div class="phone">
							<a target="_blank" href="https://api.whatsapp.com/send?phone=6282390156897&text=&source=&data=&app_absent="><i class="icofont-whatsapp"></i></a>
							<h4>Whatsapp:</h4>
							<p>082390156897</p>
						</div>
					</div>
				...
				<div class="col-md-3">
					<div class="info">
						<div class="phone">
							<a target="_blank" href="https://www.instagram.com/ratih_makeupart/"><i class="icofont-instagram"></i></a>
							<h4>Instagram:</h4>
